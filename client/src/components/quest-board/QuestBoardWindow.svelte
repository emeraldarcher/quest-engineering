...
.availability-copy { min-height:2.25rem; }.text-action { min-height:auto!important; padding:.25rem 0!important; color:var(--app-teal-dark)!important; background:transparent!important; border:0!important; box-shadow:none!important; font-size:.78rem!important; font-weight:800; text-decoration:underline; }.member-lines { display:grid; gap:.22rem; margin:.45rem 0 .25rem; padding:0; list-style:none; }.member-lines li { display:flex; gap:.4rem; margin:0; font-size:.74rem; }.member-lines strong { color:#405454; }.member-lines span { color:#78827b; }.configuration-warning { color:#934842!important; }.semantic-flow { grid-column:2; grid-row:1/5; display:flex; align-items:center; justify-content:center; gap:.4rem; min-width:0; padding:.45rem; background:#f4e6c8; border-radius:7px; }.semantic-flow div { padding:.4rem .55rem; color:#31524e; background:#fffaf0; border:1px solid #92aa9a; border-radius:6px; font-size:.78rem; font-weight:800; text-align:center; }.semantic-flow i { color:#9a7043; font-style:normal; }.semantic-flow .remediation { display:grid; gap:.08rem; color:#854b37; border-color:#d28b6c; }.semantic-flow .remediation span { font-size:.58rem; text-transform:uppercase; }.semantic-flow .remediation strong { font-size:.76rem; }
