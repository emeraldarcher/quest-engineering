...
- **Mini Medieval User Interface**, version 1.1 — https://v3x3d.itch.io/mini-medieval-user-interface

The official product listings identify these works as licensed under the
**Creative Commons Attribution 4.0 International license (CC BY 4.0)**:
https://creativecommons.org/licenses/by/4.0/

The full canonical license text is retained at
[`license/CC-BY-4.0.txt`](license/CC-BY-4.0.txt).

The packs document their base palette as **fruitpunch24 by Polyphrog**.
