...
The server resolves mutable reusable Product Tactic Definitions into immutable plain semantic Tactics before binding path-free launch snapshots to the pure Core Runtime and Worker Protocol v5.
...
Member binding + logical context binding + Worker slot
              ↓
ResolvedExecution → Worker Protocol v5
```
